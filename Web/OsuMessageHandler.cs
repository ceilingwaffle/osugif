...
namespace Web.Osu
{
    public class OsuMessageHandler : WebSocketHandler
    {
        public OsuMessageHandler(WebSocketConnectionManager webSocketConnectionManager) : base(webSocketConnectionManager, new ControllerMethodInvocationStrategy())
        {
